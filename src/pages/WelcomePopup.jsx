...
const WelcomePopup = ({ onClose }) => {
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 p-5" style={{ backgroundColor: 'rgba(0, 0, 0, 0.8)' }}>
      <div className="bg-[#1E2A3A] rounded-xl shadow-2xl px-6 py-12 w-[420px] flex flex-col items-center">
